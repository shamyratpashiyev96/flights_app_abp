...
namespace FlightsApp.Migrations
{
    ...
    [Migration("20231030053503_Created FlightsPassengersPivot table")]
    partial class CreatedFlightsPassengersPivottable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlightsApp.Airports.Airport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlightsApp.Flights.Flight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppFlights", (string)null);
                });

            modelBuilder.Entity("FlightsApp.FlightsPassengers.FlightPassengerPivot", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AppFlightsPassengersPivot", (string)null);
                });

            modelBuilder.Entity("FlightsApp.Passengers.Passenger", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlightsApp.Flights.Flight", b =>
                {
                    b.HasOne("FlightsApp.Airports.Airport", "Destination")
                        .WithMany("Arrivals")
                        .HasForeignKey("DestinationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FlightsApp.Airports.Airport", "Origin")
                        .WithMany("Departures")
            ...
            modelBuilder.Entity("FlightsApp.FlightsPassengers.FlightPassengerPivot", b =>
                {
                    b.HasOne("FlightsApp.Flights.Flight", null)
                        .WithMany()
                        .HasForeignKey("FlightId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FlightsApp.Passengers.Passenger", null)
                        .WithMany()
